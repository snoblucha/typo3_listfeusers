...
t3lib_extMgm::addPiFlexFormValue($_EXTKEY . '_pi3', 'FILE:EXT:listfeusers/pi3/flexform_ds.xml');
...
t3lib_extMgm::addStaticFile($_EXTKEY, 'pi1/static/', 'List users');
t3lib_extMgm::addStaticFile($_EXTKEY, 'pi2/static/', 'Display logged user');
t3lib_extMgm::addStaticFile($_EXTKEY, 'pi3/static/', 'Map with users');
